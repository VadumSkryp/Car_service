...
public class CustomerService {
    ...
    public int registerCustomer(String name, String phone, String email) throws DaoException {
        return customerDao.create(new Customer(0, name, phone, email));
    }

    public List<Customer> listCustomers() throws DaoException { return customerDao.findAll(); }

    public Optional<Customer> getCustomer(int id) throws DaoException { return customerDao.findById(id); }

    public List<Car> getCustomerCars(int customerId) throws DaoException { return carDao.findByCustomerId(customerId); }
}
